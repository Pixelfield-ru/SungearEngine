...
///
/// Even if it's highly unrecommended, it's possible to date all the extensions at once by
...
/// for them.
///
/// Even if it's highly unrecommended, it's possible to date all the extensions
