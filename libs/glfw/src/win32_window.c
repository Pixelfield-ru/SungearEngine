...
static void updateFramebufferTransparency(const _GLFWwindow* window)
{
    ...
    {
        // HACK: Disable framebuffer transparency on Window 7 when the
                                   ...
                                   WPARAM wParam, LPARAM lParam)
{
    ...
    switch (uMsg)
    {
        ...
        case WM_UNICHAR:
        {
            ...
            {
                // WM_UNICHAR is not sent by Window, but is sent by some
        ...
        case WM_MOUSEHWHEEL:
        {
            // This message is only sent on Window Vista and later
                              ...
                              const _GLFWfbconfig* fbconfig)
{
    ...
    if (!window->monitor)
    {
        ...
        // Adjust rect of maximized undecorated window, because by default Window will
...
void _glfwPlatformPollEvents(void)
{
    ...
    // NOTE: Shift keys on Window tend to "stick" when both are pressed as
    //       no key up message is generated by the first key release
    // NOTE: Window key is not reported as released by the Win+V hotkey
