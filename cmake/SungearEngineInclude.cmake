...
if(${SG_BUILD_TYPE} STREQUAL "Release")
    ...
    list(APPEND SungearEngine_INCLUDE_DIRS "$ENV{SUNGEAR_SOURCES_ROOT}/cmake-build-release/Sources/SGUtils")
    ...
    list(APPEND SungearEngine_LIBS "$ENV{SUNGEAR_SOURCES_ROOT}/cmake-build-release/Sources/SGUtils/SGUtils.${SG_DL_EXT}")
...
elseif(${SG_BUILD_TYPE} STREQUAL "Debug")
    ...
    list(APPEND SungearEngine_INCLUDE_DIRS "$ENV{SUNGEAR_SOURCES_ROOT}/cmake-build-debug/Sources/SGUtils")
    list(APPEND SungearEngine_INCLUDE_DIRS "$ENV{SUNGEAR_SOURCES_ROOT}/Externals")

    set(SungearEngine_LIBS "$ENV{SUNGEAR_SOURCES_ROOT}/cmake-build-debug/Sources/SGCore/SGCore.${SG_DL_EXT}")
    list(APPEND SungearEngine_LIBS "$ENV{SUNGEAR_SOURCES_ROOT}/cmake-build-debug/Sources/SGUtils/SGUtils.${SG_DL_EXT}")
