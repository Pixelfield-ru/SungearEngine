...
void SGCore::ShadersUniversalPaths::init() noexcept
{
    ...
    m_defaultPaths->addShader("LayeredPP/ReceiverShader",
                              "${enginePath}/Resources/sg_shaders/glsl4/postprocessing/layered/receiver_shader.glsl",
                              ShadersUniversalPaths::undefined_path,
                              ShadersUniversalPaths::undefined_path
    );

    m_defaultPaths->addShader("LayeredPP/LayerFXShader",
                              "${enginePath}/Resources/sg_shaders/glsl4/postprocessing/layered/layer_default_fx.glsl",
                              ShadersUniversalPaths::undefined_path,
                              ShadersUniversalPaths::undefined_path
    );

    m_defaultPaths->addShader("LayeredPP/FinalFrameFXShader",
                              "${enginePath}/Resources/sg_shaders/glsl4/postprocessing/layered/final_frame_fx.glsl",
                              ShadersUniversalPaths::undefined_path,
                              ShadersUniversalPaths::undefined_path
    );

    m_defaultPaths->addShader("InfiniteGrid",
                              "${enginePath}/Resources/sg_shaders/glsl4/gizmos/infinite_grid.glsl",
                              ShadersUniversalPaths::undefined_path,
                              ShadersUniversalPaths::undefined_path
    );

    m_defaultPaths->addShader("StandardOutline",
                              "${enginePath}/Resources/sg_shaders/glsl4/outline.glsl",
                              ShadersUniversalPaths::undefined_path,
                              ShadersUniversalPaths::undefined_path
    );
}
