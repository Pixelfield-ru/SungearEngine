...
namespace SGCore::Serde
{
    ...
    template<typename T, FormatType TFormatType>
    struct SerdeSpec<std::optional<T>, TFormatType> : BaseTypes<>, DerivedTypes<>
    {
        static inline const std::string type_name = "std::optional";
        static inline constexpr bool is_pointer_type = false;
        using element_type = T;

        template<typename... SharedDataT>
        static void serialize(SerializableValueView<const std::optional<T>, TFormatType>& valueView, SharedDataT&&... sharedData)
        {
        ...
        template<typename... SharedDataT>
        static void deserialize(DeserializableValueView<std::optional<T>, TFormatType>& valueView, SharedDataT&&... sharedData)
        {
