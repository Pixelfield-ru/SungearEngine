...
SGCore::PBRRenderPipeline::PBRRenderPipeline()
{
    m_shadersPaths.addShader(
            "StandardMeshShader",
            CoreMain::getSungearEngineRootPath() / "Resources/shaders/glsl4/pbr/default_shader.glsl",
    ...
    m_shadersPaths.addShader(
            ...
            CoreMain::getSungearEngineRootPath() / "Resources/shaders/glsl4/postprocessing/default_shader.glsl",
            ShadersUniversalPaths::undefined_path,
            ShadersUniversalPaths::undefined_path
    );
    ...
    m_shadersPaths.addShader(
            ...
            CoreMain::getSungearEngineRootPath() / "Resources/shaders/glsl4/shadows_generator/default_shader.glsl",
            ShadersUniversalPaths::undefined_path,
            ShadersUniversalPaths::undefined_path
    );
    ...
    m_shadersPaths.addShader(
            "SkyboxShader",
            CoreMain::getSungearEngineRootPath() / "Resources/shaders/glsl4/skybox/default_shader.glsl",
            ShadersUniversalPaths::undefined_path,
            ShadersUniversalPaths::undefined_path
    );
    ...
    m_shadersPaths.addShader(
            ...
            CoreMain::getSungearEngineRootPath() / "Resources/shaders/glsl4/debug/lines_debug_shader.glsl",
            ShadersUniversalPaths::undefined_path,
            ShadersUniversalPaths::undefined_path
    );
    ...
    m_shadersPaths.addShader(
            "StandardTextShader",
            CoreMain::getSungearEngineRootPath() / "Resources/shaders/glsl4/ui/text_shader.glsl",
            ShadersUniversalPaths::undefined_path,
            ShadersUniversalPaths::undefined_path
    );
    ...
    m_shadersPaths.addShader(
            "InstancingShader",
            CoreMain::getSungearEngineRootPath() / "Resources/shaders/glsl4/pbr/instancing.glsl",
            ShadersUniversalPaths::undefined_path,
            ShadersUniversalPaths::undefined_path
    );
    ...
    m_shadersPaths.addShader(
            "BatchingShader",
            CoreMain::getSungearEngineRootPath() / "Resources/shaders/glsl4/pbr/batching.glsl",
            ShadersUniversalPaths::undefined_path,
            ShadersUniversalPaths::undefined_path
    );
