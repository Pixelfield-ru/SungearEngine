...
namespace SGCore
{
    ...
    {
        void processParticles(const ECS::registry_t& inRegistry) const noexcept;

        void addParticle(ECS::entity_t particleEntity, ECS::registry_t& inRegistry) noexcept;
    ...
    private:
        std::vector<ECS::entity_t> m_particlesEntities;
