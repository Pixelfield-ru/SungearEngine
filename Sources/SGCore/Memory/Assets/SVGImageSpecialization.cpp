...
void SGCore::SVGImageSpecialization::resolveMemberAssetsReferences(SGCore::AssetManager* parentAssetManager) noexcept
{
    parentAssetManager->resolveAssetReference(m_texture);
}
