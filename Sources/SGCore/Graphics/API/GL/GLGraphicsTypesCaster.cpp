...
GLint GLGraphicsTypesCaster::sggInternalFormatToGL(const SGGInternalFormat& sggInternalFormat) noexcept
{
...
GLenum GLGraphicsTypesCaster::sggFormatToGL(const SGGFormat& sggFormat) noexcept
{
...
std::uint16_t GLGraphicsTypesCaster::sggDataTypeToGL(const SGGDataType& sggDataType) noexcept
{
    int apiDataType;
